...
// all blocks' seal as valid, though they still have to conform to the IonChain
// consensus rules.
...
// still have to conform to the IonChain consensus rules.
...
// they still have to conform to the IonChain consensus rules.
...
func (ethash *Ethash) APIs(chain consensus.ChainHeaderReader) []rpc.API {
	...
	// to both ionc and ethash namespaces.
	return []rpc.API{
		{
			Namespace: "eth",
			Version:   "1.0",
