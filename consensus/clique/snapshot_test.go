...
// mapped from textual names used in the tests below to actual IonChain private
...
// address retrieves the IonChain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the IonChain address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/ionchain/ionchain-core/issues/17593). Whilst this
