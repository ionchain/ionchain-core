...
// ecrecover extracts the IonChain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the IonChain address
...
// IonChain testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     ioncdb.Database      // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // IonChain address of the signing key
...
func New(config *params.CliqueConfig, db ioncdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the IonChain address recovered
