...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db ioncdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db ioncdb.Database) error {
