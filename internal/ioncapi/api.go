...
import (
	...
	//"github.com/ionchain/ionchain-core/accounts/scwallet"
...
func (s *PublicIonchainAPI) GasPrice(ctx context.Context) (*hexutil.Big, error) {
...
// Unpair deletes a pairing between wallet and ionc.
