...
type Config struct {
	Oracle common.Address // ionchain address of the release oracle
...
func NewReleaseService(ctx *node.ServiceContext, config Config) (node.Service, error) {
	// Retrieve the ionchain service dependency to access the blockchain
...
func (r *ReleaseService) checkVersion() {
	...
	if version.Major > r.config.Major ||
		...
		howtofix := fmt.Sprintf("Please check https://github.com/ionchain/ionchain-core/releases for new releases")
