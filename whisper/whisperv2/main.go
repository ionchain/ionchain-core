...
import (
	...
	"github.com/ionchain/ionchain-core/logger"
	"github.com/ionchain/ionchain-core/p2p"
	"github.com/ionchain/ionchain-core/p2p/nat"
	"github.com/ionchain/ionchain-core/whisper"
)
...
func main() {
	...
	// Create an ionchain peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting ionchain peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start ionchain peer: %v.\n", err)
		os.Exit(1)
	}
