...
import (
	...
	"github.com/ionchain/ionchain-core/crypto/ecies"
	"github.com/ionchain/ionchain-core/event/filter"
...
// Whisper represents a dark communication interface through the ionchain
...
// New creates a Whisper client ready to communicate through the ionchain P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
