...
func NewTable(db ioncdb.Database, prefix string) ioncdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) ioncdb.Iterator {
...
func (t *table) NewBatch() ioncdb.Batch {
...
func (b *tableBatch) Replay(w ioncdb.KeyValueWriter) error {
