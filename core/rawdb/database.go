...
import (
	...
	"github.com/ionchain/ionchain-core/ioncdb/leveldb"
	"github.com/ionchain/ionchain-core/ioncdb/memorydb"
...
func NewDatabase(db ioncdb.KeyValueStore) ioncdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db ioncdb.KeyValueStore, freezer string, namespace string) (ioncdb.Database, error) {
...
func NewMemoryDatabase() ioncdb.Database {
...
func NewMemoryDatabaseWithCap(size int) ioncdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (ioncdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (ioncdb.Database, error) {
...
func InspectDatabase(db ioncdb.Database) error {
