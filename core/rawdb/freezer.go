...
//   reserving it for go-ionchain. This would also reduce the memory requirements
//   of Ionc, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db ioncdb.KeyValueStore) {
