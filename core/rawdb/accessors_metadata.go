...
func ReadDatabaseVersion(db ioncdb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db ioncdb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db ioncdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db ioncdb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
