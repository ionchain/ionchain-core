...
type Block struct {
	...
	// These fields are used by package ionc to track
...
// [deprecated by ionc/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for ionc protocol, etc.
...
// DecodeRLP decodes the IonChain
...
// EncodeRLP serializes b into the IonChain RLP block format.
