...
func makeTestState() (Database, *ioncdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := ioncdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db ioncdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ioncdb.Database, root common.Hash) error {
...
func checkStateConsistency(db ioncdb.Database, root common.Hash) error {
