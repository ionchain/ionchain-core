...
// stateObject represents an ionchain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of ionchain address of the account
	data     Account
	db       *StateDB
...
// Account is the ionchain consensus representation of accounts.
