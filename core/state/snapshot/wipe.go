...
func wipeSnapshot(db ioncdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db ioncdb.KeyValueStore) error {
...
func wipeKeyRange(db ioncdb.KeyValueStore, kind string, prefix []byte, keylen int) error {
