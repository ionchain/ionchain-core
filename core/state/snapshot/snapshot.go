...
// SnapshotTree is an IonChain state snapshot tree. It consists of one persistent
...
type Tree struct {
	diskdb ioncdb.KeyValueStore     // Persistent database to store the snapshot
...
func New(diskdb ioncdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool, recovery bool) *Tree {
