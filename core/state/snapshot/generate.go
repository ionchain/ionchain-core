...
func generateSnapshot(diskdb ioncdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, wiper chan struct{}) *diskLayer {
...
func journalProgress(db ioncdb.KeyValueWriter, marker []byte, stats *generatorStats) {
...
func (dl *diskLayer) generate(stats *generatorStats) {
	...
	for accIt.Next() {
		...
		if batch.ValueSize() > ioncdb.IdealBatchSize || abort != nil {
