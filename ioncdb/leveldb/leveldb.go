...
func (db *Database) NewBatch() ioncdb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) ioncdb.Iterator {
...
func (b *batch) Replay(w ioncdb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay methods.
type replayer struct {
	writer  ioncdb.KeyValueWriter
	failure error
}
