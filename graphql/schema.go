...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte IonChain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an IonChain account at a particular block.
    type Account {
    ...
    # Transaction is an IonChain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an IonChain account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an IonChain account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an IonChain block by number or by hash. If neither is
