...
func (c *lesCommons) setupOracle(node *node.Node, genesis common.Hash, ethconfig *ionc.Config) *checkpointoracle.CheckpointOracle {
	...
	client := ioncclient.NewClient(rpcClient)
	oracle.Start(client)
