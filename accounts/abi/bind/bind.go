...
//
// Detailed usage document and tutorial available on the go-ionchain Wiki page:
// https://github.com/ionchain/ionchain-core/wiki/Native-DApps:-Go-bindings-to-IonChain-contracts
package bind
