...
type SimulatedBackend struct {
	database   ioncdb.Database  // In memory database to store our testing data
	blockchain *core.BlockChain // IonChain blockchain to handle the consensus
...
func NewSimulatedBackendWithDatabase(database ioncdb.Database, alloc core.GenesisAlloc, gasLimit uint64) *SimulatedBackend {
...
func (b *SimulatedBackend) TransactionByHash(ctx context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
	...
	return nil, false, ionchain.NotFound
}
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call ionchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call ionchain.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call ionchain.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call ionchain.CallMsg, block *types.Block, stateDB *state.StateDB) (*core.ExecutionResult, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query ionchain.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query ionchain.FilterQuery, ch chan<- types.Log) (ionchain.Subscription, error) {
...
func (b *SimulatedBackend) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (ionchain.Subscription, error) {
...
func (fb *filterBackend) ChainDb() ioncdb.Database { return fb.db }
