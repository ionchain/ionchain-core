...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain ionchain.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		signature[64] -= 27 // Transform V from IonChain-legacy to 0/1
	}
