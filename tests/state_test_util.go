...
// See https://github.com/ionchain/EIPs/issues/176 for the test format specification.
...
func makePreState(db ioncdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/ionchain/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
