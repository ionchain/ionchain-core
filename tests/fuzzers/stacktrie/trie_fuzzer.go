...
func (s *spongeDb) NewBatch() ioncdb.Batch               { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) ioncdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w ioncdb.KeyValueWriter) error { return nil }
