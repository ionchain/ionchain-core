...
type Database struct {
	diskdb ioncdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb ioncdb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb ioncdb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() ioncdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch ioncdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
