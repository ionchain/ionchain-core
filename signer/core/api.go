...
import (
	...
	"github.com/ionchain/ionchain-core/signer/storage"
)
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*ioncapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx ioncapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*ioncapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := ioncapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
