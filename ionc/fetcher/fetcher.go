...
//fetcher是用来辅助同步区块数据的，记录各个区块头和区块体的同步状态，但它并不做真正下载区块数据的事情，下载的事情交由downloader来做。
package fetcher
...
type Fetcher struct {
	...
	importedHook       func(*types.Block)      // Method to call upon successful block import (both ionc/61 and ionc/62)
}
