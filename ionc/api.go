...
func NewPublicMinerAPI(e *IonChain) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *IonChain) *PrivateMinerAPI {
...
// admin methods of the IonChain service.
func NewPrivateAdminAPI(eth *IonChain) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of IonChain full node APIs exposed
...
// related public debug methods of the IonChain service.
func NewPublicDebugAPI(eth *IonChain) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of IonChain full node APIs exposed over
...
// private debug methods of the IonChain service.
func NewPrivateDebugAPI(eth *IonChain) *PrivateDebugAPI {
...
func (api *PrivateDebugAPI) GetBadBlocks(ctx context.Context) ([]*BadBlockArgs, error) {
	...
	for i, block := range blocks {
		...
		if results[i].Block, err = ioncapi.RPCMarshalBlock(block, true, true); err != nil {
