...
import (
	...
	"github.com/ionchain/ionchain-core/ionc/tracers"
...
func (api *PrivateDebugAPI) TraceCall(ctx context.Context, args ioncapi.CallArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceConfig) (interface{}, error) {
