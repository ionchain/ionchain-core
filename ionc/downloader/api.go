...
// Syncing provides information when this nodes starts synchronising with the IonChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ionchain.SyncProgress `json:"status"`
}
