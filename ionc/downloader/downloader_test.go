...
type downloadTester struct {
	...
	stateDb ioncdb.Database // Database used by the tester for syncing from peers
	peerDb  ioncdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	testdb, _ := ioncdb.NewMemDatabase()
	...
	tester.stateDb, _ = ioncdb.NewMemDatabase()
