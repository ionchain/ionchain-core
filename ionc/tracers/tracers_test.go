...
import (
	...
	"github.com/ionchain/ionchain-core/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = ionc.getBlock(ionc.getTransaction(tx).blockHash);
  var genesis = ionc.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.ionc.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  ionc.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
