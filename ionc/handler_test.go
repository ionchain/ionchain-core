...
func testGetNodeData(t *testing.T, protocol int) {
	...
	hashes := []common.Hash{}
	for _, key := range pm.chaindb.(*ioncdb.MemDatabase).Keys() {
	...
	statedb, _ := ioncdb.NewMemDatabase()
...
// Tests that post ionc protocol handshake, DAO fork-enabled clients also execute
