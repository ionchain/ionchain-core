...
const protocolName = "ionc"

// ProtocolVersions are the supported versions of the ionc protocol (first is primary).
...
const (
	...
	// ionc protocols, reown them here.
...
// statusData63 is the network packet for the status message for ionc/63.
...
// statusData is the network packet for the status message for ionc/64 and later.
