...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage IonChain presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    ionc wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import IonChain presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	ionc wallet [options] /path/to/my/presale.wallet
...
between ionchain nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    ionc account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    ionc account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another ionchain instance,
...
func ambiguousAddrRecovery(ks *keystore.KeyStore, err *keystore.AmbiguousAddrError, auth string) accounts.Account {
	fmt.Printf("Multiple key files exist for address %v:\n", err.Addr.String())
...
func accountCreate(ctx *cli.Context) error {
	cfg := ioncConfig{Node: defaultNodeConfig()}
	// Load config file.
