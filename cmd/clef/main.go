...
import (
	...
	"github.com/ionchain/ionchain-core/signer/core"
	"github.com/ionchain/ionchain-core/signer/fourbyte"
	"github.com/ionchain/ionchain-core/signer/rules"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage IonChain account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func GenDoc(ctx *cli.Context) {
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &ioncapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
