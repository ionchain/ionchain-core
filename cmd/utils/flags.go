...
import (
	...
	"github.com/ionchain/ionchain-core/metrics/exp"
	"github.com/ionchain/ionchain-core/metrics/influxdb"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		...
		Value: ionc.DefaultConfig.NetworkId,
	}
	...
	defaultSyncMode = ionc.DefaultConfig.SyncMode
	...
	LightServeFlag = cli.IntFlag{
		...
		Value: ionc.DefaultConfig.LightServ,
	}
	LightIngressFlag = cli.IntFlag{
		Name:  "light.ingress",
		Usage: "Incoming bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
		Value: ionc.DefaultConfig.LightIngress,
	}
	LightEgressFlag = cli.IntFlag{
		Name:  "light.egress",
		Usage: "Outgoing bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
		Value: ionc.DefaultConfig.LightEgress,
	}
	LightMaxPeersFlag = cli.IntFlag{
		Name:  "light.maxpeers",
		Usage: "Maximum number of light clients to serve, or light servers to attach to",
		Value: ionc.DefaultConfig.LightPeers,
	}
	UltraLightServersFlag = cli.StringFlag{
		Name:  "ulc.servers",
		Usage: "List of trusted ultra-light servers",
		Value: strings.Join(ionc.DefaultConfig.UltraLightServers, ","),
	}
	UltraLightFractionFlag = cli.IntFlag{
		Name:  "ulc.fraction",
		Usage: "Minimum % of trusted ultra-light servers required to announce a new head",
		Value: ionc.DefaultConfig.UltraLightFraction,
	}
	...
	EthashCachesInMemoryFlag = cli.IntFlag{
		...
		Value: ionc.DefaultConfig.Ethash.CachesInMem,
	}
	EthashCachesOnDiskFlag = cli.IntFlag{
		Name:  "ethash.cachesondisk",
		Usage: "Number of recent ethash caches to keep on disk (16MB each)",
		Value: ionc.DefaultConfig.Ethash.CachesOnDisk,
	}
	...
	EthashDatasetDirFlag = DirectoryFlag{
		...
		Value: DirectoryString(ionc.DefaultConfig.Ethash.DatasetDir),
	}
	EthashDatasetsInMemoryFlag = cli.IntFlag{
		Name:  "ethash.dagsinmem",
		Usage: "Number of recent ethash mining DAGs to keep in memory (1+GB each)",
		Value: ionc.DefaultConfig.Ethash.DatasetsInMem,
	}
	EthashDatasetsOnDiskFlag = cli.IntFlag{
		Name:  "ethash.dagsondisk",
		Usage: "Number of recent ethash mining DAGs to keep on disk (1+GB each)",
		Value: ionc.DefaultConfig.Ethash.DatasetsOnDisk,
	}
	...
	TxPoolPriceLimitFlag = cli.Uint64Flag{
		...
		Value: ionc.DefaultConfig.TxPool.PriceLimit,
	}
	TxPoolPriceBumpFlag = cli.Uint64Flag{
		Name:  "txpool.pricebump",
		Usage: "Price bump percentage to replace an already existing transaction",
		Value: ionc.DefaultConfig.TxPool.PriceBump,
	}
	TxPoolAccountSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.accountslots",
		Usage: "Minimum number of executable transaction slots guaranteed per account",
		Value: ionc.DefaultConfig.TxPool.AccountSlots,
	}
	TxPoolGlobalSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.globalslots",
		Usage: "Maximum number of executable transaction slots for all accounts",
		Value: ionc.DefaultConfig.TxPool.GlobalSlots,
	}
	TxPoolAccountQueueFlag = cli.Uint64Flag{
		Name:  "txpool.accountqueue",
		Usage: "Maximum number of non-executable transaction slots permitted per account",
		Value: ionc.DefaultConfig.TxPool.AccountQueue,
	}
	TxPoolGlobalQueueFlag = cli.Uint64Flag{
		Name:  "txpool.globalqueue",
		Usage: "Maximum number of non-executable transaction slots for all accounts",
		Value: ionc.DefaultConfig.TxPool.GlobalQueue,
	}
	TxPoolLifetimeFlag = cli.DurationFlag{
		Name:  "txpool.lifetime",
		Usage: "Maximum amount of time non-executable transaction are queued",
		Value: ionc.DefaultConfig.TxPool.Lifetime,
	}
	...
	CacheTrieJournalFlag = cli.StringFlag{
		...
		Value: ionc.DefaultConfig.TrieCleanCacheJournal,
	}
	CacheTrieRejournalFlag = cli.DurationFlag{
		Name:  "cache.trie.rejournal",
		Usage: "Time interval to regenerate the trie cache journal",
		Value: ionc.DefaultConfig.TrieCleanCacheRejournal,
	}
	...
	MinerGasTargetFlag = cli.Uint64Flag{
		...
		Value: ionc.DefaultConfig.Miner.GasFloor,
	}
	MinerGasLimitFlag = cli.Uint64Flag{
		Name:  "miner.gaslimit",
		Usage: "Target gas ceiling for mined blocks",
		Value: ionc.DefaultConfig.Miner.GasCeil,
	}
	MinerGasPriceFlag = BigFlag{
		Name:  "miner.gasprice",
		Usage: "Minimum gas price for mining a transaction",
		Value: ionc.DefaultConfig.Miner.GasPrice,
	}
	...
	MinerRecommitIntervalFlag = cli.DurationFlag{
		...
		Value: ionc.DefaultConfig.Miner.Recommit,
	}
	...
	RPCGlobalGasCapFlag = cli.Uint64Flag{
		...
		Value: ionc.DefaultConfig.RPCGasCap,
	}
	RPCGlobalTxFeeCapFlag = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in ether) that can be sent via the RPC APIs (0 = no cap)",
		Value: ionc.DefaultConfig.RPCTxFeeCap,
	}
	...
	GpoBlocksFlag = cli.IntFlag{
		...
		Value: ionc.DefaultConfig.GPO.Blocks,
	}
	GpoPercentileFlag = cli.IntFlag{
		Name:  "gpo.percentile",
		Usage: "Suggested gas price is the given percentile of a set of recent transaction gas prices",
		Value: ionc.DefaultConfig.GPO.Percentile,
	}
	GpoMaxGasPriceFlag = cli.Int64Flag{
		Name:  "gpo.maxprice",
		Usage: "Maximum gas price will be recommended by gpo",
		Value: ionc.DefaultConfig.GPO.MaxPrice.Int64(),
	}
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		if ctx.GlobalBool(LegacyTestnetFlag.Name) || ctx.GlobalBool(RopstenFlag.Name) {
			// Maintain compatibility with older Ionc configurations storing the
...
func setLes(ctx *cli.Context, cfg *ionc.Config) {
	...
	if cfg.UltraLightFraction <= 0 && cfg.UltraLightFraction > 100 {
		log.Error("Ultra light fraction is invalid", "had", cfg.UltraLightFraction, "updated", ionc.DefaultConfig.UltraLightFraction)
		cfg.UltraLightFraction = ionc.DefaultConfig.UltraLightFraction
	}
...
// for Ionc and returns half of the allowance to assign to the database.
...
func setEtherbase(ctx *cli.Context, ks *keystore.KeyStore, cfg *ionc.Config) {
...
func setGPO(ctx *cli.Context, cfg *gasprice.Config, light bool) {
	...
	if light {
		cfg.Blocks = ionc.DefaultLightGPOConfig.Blocks
		cfg.Percentile = ionc.DefaultLightGPOConfig.Percentile
	}
...
func setWhitelist(ctx *cli.Context, cfg *ionc.Config) {
...
// no URLs are set.
func SetDNSDiscoveryDefaults(cfg *ionc.Config, genesis common.Hash) {
...
// RegisterEthService adds an IonChain client to the stack.
func RegisterEthService(stack *node.Node, cfg *ionc.Config) ioncapi.Backend {
	if cfg.SyncMode == downloader.LightSync {
	...
	backend, err := ionc.New(stack, cfg)
	if err != nil {
		Fatalf("Failed to register the IonChain service: %v", err)
	}
	if cfg.LightServ > 0 {
...
// RegisterEthStatsService configures the IonChain Stats daemon and adds it to
// the given node.
func RegisterEthStatsService(stack *node.Node, backend ioncapi.Backend, url string) {
	if err := ioncstats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the IonChain Stats service: %v", err)
	}
}

// RegisterGraphQLService is a utility function to construct a new service and register it against a node.
func RegisterGraphQLService(stack *node.Node, backend ioncapi.Backend, cfg node.Config) {
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "ionc.", tagsMap)
		}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) ioncdb.Database {
	var (
...
func MakeChain(ctx *cli.Context, stack *node.Node, readOnly bool) (chain *core.BlockChain, chainDb ioncdb.Database) {
	var err error
	chainDb = MakeChainDatabase(ctx, stack)
	...
	cache := &core.CacheConfig{
		TrieCleanLimit:      ionc.DefaultConfig.TrieCleanCache,
		TrieCleanNoPrefetch: ctx.GlobalBool(CacheNoPrefetchFlag.Name),
		TrieDirtyLimit:      ionc.DefaultConfig.TrieDirtyCache,
		TrieDirtyDisabled:   ctx.GlobalString(GCModeFlag.Name) == "archive",
		TrieTimeLimit:       ionc.DefaultConfig.TrieTimeout,
		SnapshotLimit:       ionc.DefaultConfig.SnapshotCache,
...
// new format.
//
// e.g. ionc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// ionc --keystore /tmp/mykeystore --lightkdf account new
//
