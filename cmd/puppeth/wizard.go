...
type wizard struct {
	...
	services map[string][]string   // ionchain services known to be running on servers
...
// converts it to an ionchain address. If an empty line is entered, the default
// value is returned.
